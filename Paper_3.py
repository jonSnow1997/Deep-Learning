...
class Column_1(nn.Module):
    def __init__(self):
        ...
        input_channel = num_input_channel + 256
        ...
        self.layer5 = nn.Sequential(
            nn.Conv2d(input_channel, 512, kernel_size=3, stride=2, padding=(3, 3)),
            # nn.MaxPool2d(kernel_size=2, stride=2),
            nn.BatchNorm2d(512),
            nn.ReLU())
    ...
    def forward(self, x):
        ...
        xc5 = torch.cat((xc4, x), 1)

        xc6 = self.layer5(xc5)

        xc2 = self.maxpool1(xc2)

        xc2 = self.avg_pool1(xc2)

        xc7 = torch.cat((xc2, xc6), 1)
